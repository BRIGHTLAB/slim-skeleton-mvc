...
class PaginationHelper 
{
    ...
    static public function WrapPrevNextPages ($url,$request,$data,$count) {
        ...
        $page_query_param = !isset($params_array['page']) ? (int) $current_page : $params_array['page'];
        $limit_query_param = !isset($params_array['limit']) ? (int) $request->getAttribute('PAGINATION_LIMIT') : $params_array['limit'];
        //$offset = isset($query_params['offset']) ? (int) $query_params['offset'] )
        $offset_query_param = !isset($params_array['offset']) ? (int) $request->getAttribute('PAGINATION_OFFSET') : $params_array['offset'];
